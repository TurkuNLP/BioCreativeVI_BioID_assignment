...
def argument_parser():
    ...
    parser.add_argument("-i", "--in_folder", type=str, help="full path of xml file resides")
    parser.add_argument("-o", "--out_folder", type=str, help="folder where text files resides")
